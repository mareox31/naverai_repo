...
public class TTSServiceImpl implements NaverService{
 ...
 @Override
	public String test(String textfile) {
	 	//mp3로 변환된 파일의 이름을 리턴받는다. 	
	 	return test(textfile, "jinho"); //매개변수2개있는데로 보냄, 화자 기본값 설정.
	}

 	//텍스트파일 입력받도록 바꿔야함, 
public String test(String textfile, String speaker)  {//파일내용, 화자.  - 파일내용 읽어서 보내는거임. //자동으로안넘어감, 파일내용 읽은 텍스트만줘야함.
